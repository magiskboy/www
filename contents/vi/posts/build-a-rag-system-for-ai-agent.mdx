...
categories:
- AI
description: "Ngày nay, AI là một phần không thể thiếu trong công việc hằng ngày của dân văn phòng, đặc biệt là dân lập trình. Tuy nhiên, những những model hiện tại có khá nhiều điểm hạn chế trong việc truy cập thông tin. Do đó, trong bài viết này, mình muốn giới thiệu cho mọi người một phương pháp để nâng cao khả năng tìm kiếm thông tin của AI cũng nhưng cách để AI có thể truy xuất thông tin hiệu quả hơn."
---

## Vấn đề

AI hay con người đều có những đặc điểm chung, do đó, chúng ta và AI sẽ gặp phải những vấn đề tương tự trong việc tìm kiếm và xử lí thông tin. Hãy đi từ chính chúng ta, vấn đề tìm kiếm và xử lí thông tin ở con người.

Hãy giả sử bạn là một người thông minh, có thể xử lí và phân tích thông tin rất tốt. Nhưng có một hạn chế là có những thông tin bạn chưa hề biết.

Ví dụ, tôi hỏi bạn: RAG là gì?. Nếu bạn chưa có thông tin về RAG, bộ não của bạn sẽ hoạt động như sau.

1. Có thông tin về RAG chưa? Nếu chưa thì lên Google tìm kiếm với từ khoá là "RAG"

2. Nhìn vào kết quả trả về, lấy ra n kết quả đầu tiên khớp nhất với câu hỏi và đọc chúng
...
Điều này cũng đúng với AI hiện tại. AI tuy không thể biết hết, nhưng chúng có khả năng phân tích sâu các thông tin mà chúng ta đưa vào, từ đó đưa ra kết quả.

## Hiểu đơn giản về RAG

Mục đích của RAG là tìm kiếm thông tin cho AI model.

Hiểu đơn giản, trong một hệ thống RAG, chúng ra có 2 thành phần chính:

- bộ tìm kiếm thông tin
- bộ xử lí thông tin

Bộ tìm kiếm thông tin sẽ tìm trong tập lớn dữ liệu và trả về một số lượng kết quả liên quan nhất tới câu truy vấn. Sau đó, những thông tin này cùng với truy vấn sẽ được AI model phân tích, xử lí và xuất ra kết quả.
...
Trong bài viết này, bộ thông tin là toàn bộ email của mình, được ingest và đẩy vào trong RediSearch.

Một email sau khi tải về từ Gmail sẽ được vector hoá bằng thuật toán embedding, vấn đề này mình sẽ đi sâu hơn ở các bài viết sau.
...
Mình sử dụng Python và những thư viện sau
...
<iframe width="100%" src="https://www.youtube.com/embed/KSenNT42C-Q?si=PwOjFPo6Q7TWNtuX" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
