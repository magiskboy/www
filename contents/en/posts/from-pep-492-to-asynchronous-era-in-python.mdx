---
title: "Từ PEP 492 tới kỉ nguyên asynchronous trong Python"
...
Ở phiên bản gốc, bạn phải biết những khái niệm như nonblocking socket, multiplexer, selector, ... của OS đễ có thể triển khai một ứng dụng xử lí bất đồng bộ các network operator thì giờ đây chuyện đó "dễ như trở bàn tay". 
...
Xử lí bất đồng bộ trong Python là hoàn toàn có thể do Python hỗ trợ các API nonblocking socket của OS như selector, multiplexing,... Tuy nhiên, sử dụng các API này để triển khai một ứng dụng bất đồng bộ khá khó khăn.
...
Do đó, những lập trình viên trong cộng đồng đã kết hợp những API đó với Coroutine đển thực hiện việc triển khai bất đồng bộ.

Coroutine là một khái niệm trong rất nhiều ngôn ngữ lập trình và lần đầu được giới thiệu trong Python với [PEP 342](https://peps.python.org/pep-0342/) do Guido van Rossum và Phillip J. Eby đề xuất vào năm 2005 trong phiên bản Python 2.5.

Để hiểu rõ hơn việc sử dụng coroutine để triển khai lập trình bất đồng bộ như thế nào, các bạn có thể đọc 2 bài viết này của mình để chi tiết hơn:
...
Vào tháng 9 - 2018, phiên bản 1.0 của ASGI ra đời, mở đầu cho 1 kỉ nguyên web development của Python. Với việc ASGI ra đời, một loạt các thư viện và framework hỗ trợ bất đồng bộ ra đời như uvicorn, hypercorn, django v3, fastapi, starlette, quart, sanic,...
...
Với http client, ta có thể sử dụng [httpx](https://github.com/encode/httpx), nó hoàn toàn tương thích với requests.
...
- 1993: Python được tạo ra và hỗ trợ low-level API cho non-blocking
