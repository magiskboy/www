...
- Web development
- Python
description: "Recently, there has been a web framework become popular in the Python community - FastAPI. In this post, I show you how FastAPI is good and why you decided on FastAPI for development APIs"
---
...
Đi từ gốc rễ, mình sẽ chỉ cho các bạn thấy một nghịch lí trong Python. Hãy đọc kĩ gist này của mình [gist](https://gist.github.com/magiskboy/1b7a49b3f195c819829eb303e7ee1479)

Let's read my gist [gist](https://gist.github.com/magiskboy/1b7a49b3f195c819829eb303e7ee1479) and keep in mind: sync functions handle IO-bound nicely if you run it in the multi-thread environment.
...
This problem also discuss [here](https://github.com/tiangolo/fastapi/discussions/7095)
...
Finally, let's use FastAPI right, this makes use of the advantages of FastAPI. In my opinion, FastAPI is an impressive framework, we should thank [@tiangolo](https://github.com/tiangolo) for creating it.
