...
Let's read my [gist](https://gist.github.com/magiskboy/1b7a49b3f195c819829eb303e7ee1479) and keep in mind: sync functions handle IO-bound nicely if you run it in the multi-thread environment.
