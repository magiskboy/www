...
<Resume>
    ...
    <Address
        left={[
			<span>Địa chỉ: <a target="_blank" href="https://goo.gl/maps/RMTJxcaQxWt31WiL8">Hoài Đức, Hà Nội</a></span>,
			<span>Ngày sinh: <time dateTime="1998-04-24">24/04/1998</time></span>
        ]}
        right={[
			<span>Skype: <a target="_blank" href="https://join.skype.com/invite/bFZVFCglRj0q">live:nguyenkhacthanh244</a></span>,
			<span>Thư điện tử: <a target="_blank" href="mailto:nguyenkhacthanh244@gmail.com">nguyenkhacthanh244@gmail.com</a></span>,
			<span>CV cá nhân <a target="_blank" href="https://docs.google.com/document/d/1FL2BEoZZCIY0V1-9nBNsRllGtwMTCbNgvm8b21Uf8WA">tại đây</a></span>
        ]}
    />
