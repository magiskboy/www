...
import asyncOverviewImage from "static/images/async-overview.jpg";
import ipStatistic from "static/images/IP-statistic.png";
import ipStatistic2 from "static/images/IP-Statistic-v2.png";
import subroutineCoroutine from "static/images/subroutine_coroutine.png";
import coThread from "static/images/co-thread.png";
import simpleDataProcessing from "static/images/simple-data-processing.png";
import osSched from "static/images/os-scheduler.png";

export const meta = {
  title: "Bất đồng bộ trong Python - Coroutine | Phần 1",
  date: new Date("2021-03-19T08:37:00+07:00"),
  tags: ["python", "programming", "network", "asynchronous", "coroutine"],
  categories: ["Python"],
  description:
...
<Image src={subroutineCoroutine} title="Subroutine vs Coroutine" />
...
<Image src={coThread} title="Coroutine vs Thread" />
...
<Image src={simpleDataProcessing} title="Mô hình xử lí dữ liệu" />
...
<Image src={ipStatistic} title="Thống kê IP" />
...
<Image src={ipStatistic2} title="Kết hợp coroutine và thread" />
...
<Image src={osSched} title="Operation system scheduler" />
